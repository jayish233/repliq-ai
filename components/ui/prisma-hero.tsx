  ...
  return (
    <section className="h-screen w-full">
      <div className="relative h-full w-full overflow-hidden rounded-2xl md:rounded-[2rem]">
        ...
        {/* Vignette overlay */}
        <div className="vignette-overlay pointer-events-none absolute inset-0 z-10" />

        {/* Gradient overlay */}
        <div className="pointer-events-none absolute inset-0 bg-gradient-to-b from-black/30 via-transparent to-black/60 z-10" />


        {/* Hero content */}
        <div className="absolute bottom-0 left-0 right-0 px-4 pb-12 sm:px-6 md:px-10 md:pb-16">
